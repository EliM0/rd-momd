...
from open_spiel.python.mfg.algorithms import TRNN_munchausen_deep_mirror_descent
...
flags.DEFINE_integer("epsilon_decay_duration", 200000,
...
flags.DEFINE_integer("trajectory_replay_buffer_capacity", 40000,
                     "Size of the trajectory replay buffer.")
flags.DEFINE_integer("min_trajectory_replay_buffer_size_to_learn", 500,
                     "Number of trajectories in buffer before learning begins.")
flags.DEFINE_integer("trajectory_sample_length", 26,
                     "Length of trajectory.")
flags.DEFINE_integer("trajectory_sample_overlap_length", 10,
                     "Length of overlapping.")
flags.DEFINE_integer("burn_in_length", 5,
                     "Length of overlapping.")
...
flags.DEFINE_string(
    "logdir", "/Users/lichangling/Desktop/Research/BatuYardim/meanfieldgame/code/open_spiel-master/open_spiel/python/mfg/examples/save",
...
def main(argv: Sequence[str]) -> None:
  ...
  kwargs = {
      ...
      "trajectory_replay_buffer_capacity": FLAGS.trajectory_replay_buffer_capacity,
      "min_trajectory_replay_buffer_size_to_learn": FLAGS.min_trajectory_replay_buffer_size_to_learn,
      "trajectory_sample_length": FLAGS.trajectory_sample_length,
      "trajectory_sample_overlap_length": FLAGS.trajectory_sample_overlap_length,
  ...
  agents = [
      TRNN_munchausen_deep_mirror_descent.TRNNMunchausenDQN(p, info_state_size+distribution_size,
                                                   num_actions, **kwargs)
      for p in range(num_players)
  ]
  ...
  md = TRNN_munchausen_deep_mirror_descent.TRNNDeepOnlineMirrorDescent(
      game,
      envs,
      agents,
