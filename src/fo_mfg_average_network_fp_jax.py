...
from open_spiel.python.jax import fo_dqn
from open_spiel.python.mfg import utils
from open_spiel.python.mfg.algorithms import fo_average_network_fictitious_play
...
def main(argv: Sequence[str]) -> None:
  ...
  # print("distribution_size: ", distribution_size)
  ...
  br_rl_agents = [
      fo_dqn.DQN(p, info_state_size+distribution_size, num_actions, **kwargs_dqn)
      for p in range(num_players)
  ]
  ...
  fp = fo_average_network_fictitious_play.FOAverageNetworkFictitiousPlay(
      game,
      envs,
      br_rl_agents,
