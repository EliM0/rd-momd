...
class MunchausenDeepMirrorDescent(MFGAlgorithm):
    def __init__(self, game_name, game_setting, cfg, logdir='runs/D-MOMD'):
...
class ObsMunchausenDeepMirrorDescent(MFGAlgorithm):
    def __init__(self, game_name, game_setting, cfg, observability=False, logdir='runs/FO-DMOMD'):
        super().__init__(game_name, game_setting, cfg)
...
class AverageFictitiousPlay(MFGAlgorithm):
    def __init__(self, game_name, game_setting, cfg, logdir='runs/D-AFP'):
        super().__init__(game_name, game_setting, cfg)
...
class ObsAverageFictitiousPlay(MFGAlgorithm):
    def __init__(self, game_name, game_setting, cfg, observability=False, logdir='runs/FO-DAFP'):
        super().__init__(game_name, game_setting, cfg)
